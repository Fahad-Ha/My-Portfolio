 ...
 */
export default function QueeTerms() {
  const [darkMode, setDarkMode] = useState(false);

  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Terms of Use – Quee</title>
        <meta
          name="description"
          content="Terms of Use for Quee – applicable to iOS and Android"
        />
        ...
        <section className="min-h-screen">
          ...
          <div className="text-left bg-gray-50 dark:bg-gray-800 rounded-lg p-8 space-y-6">
            ...
            <p className="dark:text-gray-200">
              By installing or using <strong>Quee</strong> you confirm that you
              have read and agree to the applicable store terms{" "}
            ...
            <ul className="list-disc pl-5 dark:text-gray-200 space-y-2">
              ...
              <li>
                A VIP subscription unlocks premium features — such as premium
                categories, private room hosting, and additional settings — for
                as long as your subscription is active. These benefits are a
                limited, personal, revocable license to access features within
                the Game; they have no cash value and are non-transferable.
              </li>
              <li>
                We may change subscription prices, plan contents, and which
                features are included at any time. Premium features and content
                may be modified, replaced, or removed at any time.
              </li>
              <li>
                <strong>Renewal & cancellation :</strong> Subscriptions renew
                automatically unless cancelled at least 24 hours before the end
                of the current period. You can manage or cancel your
                subscription in your App Store or Google Play account settings.
              </li>
              <li>
            ...
            <ul className="list-disc pl-5 dark:text-gray-200 space-y-2">
              ...
              <li>Contains sexual, violent, or otherwise unlawful content</li>
              <li>Impersonates others or uses an offensive display name</li>
              <li>Cheats, exploits bugs, or uses automated tools</li>
              <li>
                Artificially inflates progression, rankings, or engagement — for
                example, by using multiple accounts or automation
              </li>
              <li>
            ...
            <p className="dark:text-gray-200">
              ...
              conduct violates these Terms, and to mute players so you no longer
              see their messages. Reports are reviewed by our moderation team and
              may result in warnings, kicks, or permanent bans. Hosts of private
              rooms may also remove disruptive players directly. We may take
              action against accounts at our discretion based on report patterns,
              content review, or system signals.
            </p>
            ...
            <p className="dark:text-gray-200">
              Features, content, or premium benefits may change or be
            ...
            <p className="dark:text-gray-200">
              ...
              version on this page. The &ldquo;Last updated&rdquo; date above
              reflects the effective date of the most recent revision, and we
              encourage you to review these Terms periodically. Your continued
              use of the Game after a revised version is posted constitutes
              acceptance of the updated Terms. If you do not agree, you must stop
              using the Game.
            </p>
      ...
      <footer className="text-center bg-white text-gray-800 pt-5 pb-2 dark:text-gray-200 dark:bg-gray-900">
        © 2026 Quee – Developed with ❤️ in Kuwait
      </footer>
    </div>
  );
}
