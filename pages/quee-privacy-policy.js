...
export default function QueePrivacyPolicy() {
  const [darkMode, setDarkMode] = useState(false);

  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Privacy Policy - Quee</title>
        <meta name="description" content="Privacy Policy of the Quee App" />
      ...
      <main className="bg-white text-black px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="text-xl font-burtons">Quee</h1>
          ...
          <div className="text-left bg-gray-50 dark:bg-gray-800 rounded-lg p-8">
            ...
            <ul className="list-disc pl-5 dark:text-gray-200">
              <li>
                ...
                Google Sign‑In or Apple Sign‑In, we collect basic profile
              ...
              <li>
                ...
                community content), in‑game stats, gameplay history, and your
                progression — including XP, daily streaks, and league standing.
              </li>
              <li>
              ...
              <li>
                <strong>1.4 Chat & Messages:</strong> Chat and quick messages you
                send to other players in game rooms are transmitted through our
                servers so they can be delivered to other participants. We may
                also temporarily process this content for safety and moderation
                purposes.
              </li>
              <li>
              ...
              <li>
                <strong>1.6 Purchases & Subscription Data:</strong> Your VIP
                subscription status, in‑app purchase history, and the
                entitlement records tied to your account.
              </li>
              <li>
              ...
              <li>
                ...
                analytics or purchase providers, they may collect data per their
                own policies.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-5 dark:text-gray-200">
              <li>Provide and improve the Quee gameplay experience.</li>
              <li>Analyze app performance and usage.</li>
              <li>Process subscriptions securely.</li>
              <li>
                Track and display your progression — including XP, daily
                streaks, and league standing.
              </li>
              <li>
                Detect and prevent fraud and abuse, including analyzing device
                identifiers and usage patterns to protect the integrity of
            ...
            <p className="pt-2 dark:text-gray-200">
              <strong>Important — what happens when you delete your account?</strong>
            </p>
            <ul className="list-disc pl-5 dark:text-gray-200">
              <li>
              ...
              <li>
                ...
                you’ve shared publicly) will be anonymized and stay available to
                the community.
              </li>
              <li>
                <strong>Your personal data</strong> (profile info, email, etc.)
                is wiped out entirely.
              </li>
            </ul>
            <p className="pt-2 dark:text-gray-200">
              <strong>Want to remove public content, too?</strong> Please reach
              out to our support team before deleting your account, and we’ll
            ...
            <ul className="list-disc pl-5 dark:text-gray-200">
              ...
              <li>
                <strong>Other Players:</strong> Your display name, in‑game
                scores, league standing, and public community content are
                visible to other players you share game rooms or public
                community content with. Chat and quick messages are visible only
                to the players in the specific game room where you send them —
                not to other players outside that room.
              </li>
              <li>
                <strong>Service Providers:</strong> We share data with trusted
                partners for analytics and purchase processing. In‑app purchases
                and subscriptions are processed with the help of{" "}
            ...
            <p className="dark:text-gray-200">
              ...
              Chat and quick messages are stored only for the duration of an
              active game session and are not persisted afterward. Moderation
              reports are retained for up to 12 months for safety review
              purposes. Game stats, history, and progression are retained for as
              long as your account exists. Subscription and purchase records are
              retained for the life of your account for support, accounting, and
              legal purposes. When you delete your account, personal data is
              removed as described in Section 3.
            </p>
            ...
            <p className="dark:text-gray-200">
              Quee is rated appropriately by store rating boards (IARC on Google
              Play and Apple&apos;s age‑rating system on the App Store) based on
              its features, including in‑app chat and user‑generated content. We
            ...
            <p className="dark:text-gray-200">
              We use third‑party tools to run the service, including Firebase
              (analytics and diagnostics) provided by Google and RevenueCat for
              purchase processing. Their data practices are governed by their own
              privacy policies.
            </p>
            ...
            <p className="dark:text-gray-200">
              Quee is a social game. To keep it safe and welcoming, users must
            ...
            <p className="pt-2 dark:text-gray-200">
              <strong>Blocking and removal.</strong> You can mute other players
              so you no longer see their messages, and hosts can remove players
            ...
            <p className="dark:text-gray-200">
              We may update this policy periodically. Changes take effect as soon
              as they’re posted in the app.
            </p>
            ...
            <p className="dark:text-gray-200">
              Quee offers subscription-based premium features (VIP). Payments are
              processed via your device’s app store with the help of RevenueCat;
              we do not store your payment details. By making a purchase, you
